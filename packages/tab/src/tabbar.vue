<template>
  <div class="future-tabbar"
    :class="{'future-tabbar-fix-bottom': fixBottom}"
    ref="viewArea">
    <div class="future-tab-list"
         :style="style"
         ref="list">
      <slot></slot>
...
.future-tabbar.future-tabbar-fix-bottom {
  position: fixed;
  bottom: 0;
  left: 0;
  right: 0;
...
.future-tabbar.future-tabbar-fix-bottom .future-tab-item {
...
.future-tab-item:not(:first-child) {
  margin-left: 15px;
}
</style>
